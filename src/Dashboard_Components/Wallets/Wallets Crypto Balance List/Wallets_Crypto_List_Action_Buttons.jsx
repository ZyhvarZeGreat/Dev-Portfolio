...
const Wallets_Balance_List_Action_Buttons = () => {
  ...
  return (
    <div className="urcrypto_dashboard_wallet_crypto_balance_list_action_buttons" style={{display: 'flex', width: '100%',flexDirection: 'row' , alignItems: 'center' ,justifyContent: 'space-around'}}>
