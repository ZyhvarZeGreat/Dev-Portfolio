...
const Crypto_desc = (props) => {
  return (
    <div className='urcrypto_wallet_list_description' style={{display:"flex",height:"3rem", width :"11rem", flexDirection:"row",alignItems:"center",justifyContent:"space-around"}}>
