...
<div className="urcrypto_personal_information_content">
  <div className="urcrypto_personal_information_content_header">
    <h3>Profile</h3>
    <p>The information here will determine how your credentials are displayed</p>
  </div>
...
<button className="urcrypto_personal_information_save_btn" type="submit" placeholder="Save">
    Save
  </button>
  <button className="urcrypto_personal_information_cancel_btn" type="submit"> Cancel</button>
</div>
</div>
</div>
